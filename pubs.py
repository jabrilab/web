...
class Publications:
    ...
    def store_markdown_output_for_pubs(self, output_file_path):
        ...
        W('{:.notice}\n')
        W("For a complete list of publications, please see <a href='https://scholar.google.com/citations?user=OCLSyOwAAAAJ' target='_blank'>Bana's Google Scholar page</a>.\n")
